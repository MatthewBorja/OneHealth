...
const {index, loginView, profile, /*indexView,*/ staffView, billingView, patientsView, profileView1, patient1View, patientfileView} = require('../controllers/homeController');
...
router.get('/patient-file', requiresAuth(), patientfileView);
